...
export function LanguageToggle() {
  ...
  return (
    <button
      ...
      className="shrink-0 rounded-md px-1.5 py-2 text-sm font-medium text-[var(--brand-muted)] transition-colors hover:text-[var(--brand-silver)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-blue)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)]"
    >
