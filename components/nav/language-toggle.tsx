...
export function LanguageToggle() {
  ...
  return (
    <button
      ...
      className="shrink-0 rounded-md px-1 py-2 text-xs font-medium text-[var(--brand-muted)] transition-colors hover:text-[var(--brand-silver)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-gold-mid)] focus-visible:ring-offset-2 focus-visible:ring-offset-black"
    >
