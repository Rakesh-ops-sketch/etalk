      ...
      >
        ...
        <div className="flex flex-col gap-3.5">
          ...
          >
            ...
            <input
              ...
              className="min-h-11 w-full rounded-xl border border-[var(--hairline)] bg-[var(--surface-elevated)] px-3.5 py-2.5 text-[var(--foreground)] outline-offset-2 placeholder:text-[var(--brand-muted)]/70 focus:border-[rgba(0,102,255,0.45)] focus:outline-2 focus:outline-offset-1 focus:outline-[var(--brand-blue)]"
            />
          </label>
          <label
            className={`flex flex-col gap-1.5 text-sm text-[var(--brand-silver)] ${oria}`}
        ...
        >
          <button
            ...
            className="inline-flex min-h-11 items-center justify-center rounded-full border border-[var(--hairline)] bg-[var(--surface-elevated)] px-5 text-sm font-medium text-[var(--brand-silver)] shadow-[0_1px_2px_rgba(0,71,204,0.06)] transition-colors hover:border-[rgba(0,102,255,0.35)] hover:bg-[#fffef9] hover:text-[var(--brand-blue-deep)]"
          >
            {w.cancel}
          </button>
          <button
