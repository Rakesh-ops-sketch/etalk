  ...
  return (
    <div className="mt-14">
        ...
        >
          {cards.map((card) => (
            <article
              key={card.title}
              data-audience-card
              className="etalk-audience-card flex w-[min(100%,18.5rem)] shrink-0 snap-start flex-col rounded-2xl border border-[var(--hairline)] bg-[var(--surface-elevated)] px-5 py-5 shadow-[0_12px_40px_rgba(0,71,204,0.1)] [box-shadow:0_12px_40px_rgba(0,71,204,0.08),inset_0_1px_0_rgba(255,255,255,0.85)] sm:w-80"
            >
              <h3
      ...
      >
        <button
          type="button"
          className="inline-flex min-h-10 min-w-[2.75rem] items-center justify-center rounded-full border border-[var(--hairline)] bg-[var(--surface-elevated)] px-3 text-[var(--brand-silver)] shadow-[0_1px_2px_rgba(0,71,204,0.06)] transition-[background-color,border-color,color] hover:border-[rgba(0,102,255,0.35)] hover:bg-[#fffef9] hover:text-[var(--brand-blue-deep)]"
